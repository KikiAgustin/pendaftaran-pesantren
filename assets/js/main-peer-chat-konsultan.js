...
function getStateOfChat() {
	if(!instanse){
		...
		$.ajax({
			...
			crossDomain: true,
			cache: false,
			url: "https://www.dfunstation.com/api4/android/index.php/member/peerchatkonsultan/"+chatid+"/"+localStorage.userid+"/?callback=?",
...
function updateChat() {
	...
	if(!instanse){
		...
		$.ajax({
			...
			crossDomain: true,
			cache: false,
			url: "https://www.dfunstation.com/api4/android/index.php/member/peerchatkonsultan/"+chatid+"/"+localStorage.userid+"/"+localStorage.lastchatid+"/?callback=?",
